  ...
  return (
    <section className="py-14">
      <Container>
        ...
        <h1 className="mt-4 font-title text-4xl md:text-5xl leading-[1.05]">Les pasteurs</h1>
        <p className="mt-5 max-w-2xl text-base md:text-lg text-black/70">
          Découvrir les personnes qui servent l’église, leur cœur et leur vision.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">

    <a href="/contact" className="inline-flex items-center rounded-xl bg-brand px-5 py-3 text-white hover:opacity-90 transition-opacity">
      Contacter l’équipe
    </a>
