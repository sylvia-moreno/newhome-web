...
export default async function FAQ() {
  ...
  const fallback = [
    {
      question: "Comment venir dimanche ?",
      answer: "Arrive 10 minutes avant, viens comme tu es, on t’accueille.",
      id: 1,
    },
    {
      question: "Y a-t-il un accueil enfants ?",
      answer: "Selon les équipes présentes, on t’indique sur place.",
      id: 2,
    },
    {
      question: "Puis-je demander la prière ?",
      answer: "Oui. Passe par la section Contact ou viens à la fin du culte.",
      id: 3,
    },
  ];
